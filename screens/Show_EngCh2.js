...
class Show_EngCh2 extends Component {
  constructor(props) {
    i=+1;
    super(props);
    this.uid = Firebase.auth().currentUser.uid;
    this.engch2 = Firebase.database().ref("EngCh2");
    this.count = Firebase.database().ref().child('countEngCh2');
    this.state = {
        engch2: [],
        id : '',
        user : '',
