...
class Show_SciCh2 extends Component {
  constructor(props) {
    i=+1;
    super(props);
    this.uid = Firebase.auth().currentUser.uid;
    this.scich2 = Firebase.database().ref("SciCh2");
    this.count = Firebase.database().ref().child('countSciCh2');
    this.state = {
        scich2: [],
        id : '',
        user : '',
